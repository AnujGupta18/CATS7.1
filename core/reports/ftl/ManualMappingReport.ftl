   ...
   <body>
      ...
      <div class="row myRow">
         ...
         <div class="header">
            ...
            <h3 class="titleReport">Manual Mapping Report</h3>
         </div>
      </div>
                     ...
                     <table class="table table-bordered">
                        ...
                        <thead>
                           ...
                           <tr style="background-color:#f8f7ff">
                              <th class="dataAlign">Config</th>
                              <th class="dataAlign">Passed</th>
                              <th class="dataAlign">Failed</th>
                              <th class="dataAlign">Skipped</th>
                              <th class="dataAlign" style="width:18%">Partially Skipped</th>
                              <th class="dataAlign">No Run</th>
