   ...
   <body>
      ...
      <div class="row myRow">
         <div class="column">
            ...
            <p class="duration">Total time taken ${totalDuration}</p>
         </div>
         <div class="header">
            ...
            <h1 class="projTitle">${catsprojectName}</h1>
                  ...
                  <div class="table-responsive" style="margin-top: -15px;">
                     <table class="table table-bordered">
			            ...
			            <td class="${resultColor} dataAlign">
			           	<a href="bddreport_${reportforScenario.featureId}.html?type=listVType"><span style="color:white">${reportforScenario.suiteName}</span></a>
                         </td>
                         <td class="dataAlign">
                         ...
                         <td class="result_pass dataAlign bandwidth">
                         <#else>
                         <td class="dataAlign">
                         </#if>
                         ...
                         <#if overAllFailCountScenario gt 0>
                         <td class="result_fail dataAlign bandwidth">
                         <#else>
                         <td class="dataAlign">
                         </#if>
                         ...
                         <td class="dataAlign bandwidth">${stepdefPartiallySkippedCount} [${stepPartial?string["0.##"]}%]</td>
                         <#assign stepSkip=stepdefSkipCount/totalSteps*100>
                         <td class="dataAlign bandwidth">${stepdefSkipCount} [${stepSkip?string["0.##"]}%]</td>
                     ...
                     <#list bddReportOutcome as reportforScenario>
                        ...
                        <thead>
                           <th class="${resultColor}" colspan="2">
                              <a href="bddreport_${reportforScenario.featureId}.html?type=boxVType">
                                 <div style="color:white;text-align:center;font-size:20px">${reportforScenario.suiteName}</div>
                              </a>
                           </th>
                        </thead>
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td class="specialRow">${overAllPassCountScenario} of ${totalScenario} [${passScenario?string["0.##"]}%]</td>
                              <#else>
                           ...
                           <tr>
                              ...
                              <td class="specialRow">${stepdefPassCount} of ${totalSteps} [${stepPassPercentage?string["0.##"]}%]</td>
                              <#else>
                              ...
                              <td class="specialRow">${testStepPassCount} of ${totalActions} [${testStepPassPercentage?string["0.##"]}%]</td>
                              <#else>
                           ...
                           <tr>
                              ...
                              <td>${executionBoxPercentage?string["0.##"]}</td>
                           </tr>
                           <tr>
                              <th>Duration</th>
      ...
      <div class="footer-bottom ${result}">
         ...
         <div class="col-sm-4 ">
            ...
            <span style="float:right;font-size:22px;">${EXECUTIVE_OVERALL_PASS_PERCENTAGE_BASED_ON} Execution Rate :${overallExecutionRatePercentage?string["0.##"]}%</span>
         </div>
      </div>
