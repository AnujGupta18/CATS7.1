...
*
**/
public class  SCENARIOS_28  extends TestConfig{
	SoftAssert softAssert;
	String testDataKey;
	String sheetName;

	private static CATSLogger catsLogger = CATSLogger.getInstance(SCENARIOS_28.class);
    ...
    public synchronized void endScenario(ITestContext context) {
		synchronized (this) {
		    try {
				...
				String scenarioID = "SCENARIOS_28";
	...
	@Test (priority=1,groups={"SCENARIOS_28"})
	public void COMMON_LaunchSite1(ITestContext context) {
		...
		try {
			...
			testCase=new COMMON_LaunchSite(context,1,"SCENARIOS_28",0, this.getSuiteDriver());
	...
	@Test (priority=2,groups={"SCENARIOS_28"})
	public void COMMON_MyAccountClick2(ITestContext context) {
		COMMON_MyAccountClick testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_MyAccountClick(context,2,"SCENARIOS_28",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=3,groups={"SCENARIOS_28"})
	public void COMMON_RegisterAnAccount3(ITestContext context) {
		COMMON_RegisterAnAccount testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_RegisterAnAccount(context,3,"SCENARIOS_28",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=4,groups={"SCENARIOS_28"})
	public void COMMON_GlobalMsgRegistrationSuccess4(ITestContext context) {
		COMMON_GlobalMsgRegistrationSuccess testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_GlobalMsgRegistrationSuccess(context,4,"SCENARIOS_28",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=5,groups={"SCENARIOS_28"})
	public void COMMON_CloseWindow5(ITestContext context) {
		COMMON_CloseWindow testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_CloseWindow(context,5,"SCENARIOS_28",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
