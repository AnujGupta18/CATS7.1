...
*
**/
public class  PLPCLICKSEARCHRESULT extends DynamicInstTestcaseClassExtend {
	    
    public PLPCLICKSEARCHRESULT(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
		    Properties prop;
			try {
	     	...
	     	LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","PLPCLICKSEARCHRESULT");
	     	this.scn_exe_tc_seq=scn_exe_tc_seq;
	     	this.testCaseId = "PLP_CLICKSEARCHRESULT";		
	}
		
	    
		
	public  synchronized void  executeTestcase() {
		catsLogger.console("Test case is running : PLPCLICKSEARCHRESULT");
		String locString="";
		try{
		...
		//Test step 1.
		setComputedActuals("","","PLP", "PLP","ProductNameLink2","","");			
		executeTestStep("134",  "SCROLLINTOVIEW",": Scolls the <ProductNameLink2> into view",	suiteName, "PLPCLICKSEARCHRESULT", 
			actualData,expectedResult,actualDataRef,expectedResultRef,"",	"", "XPATH#del#//*[@class='columns small-9 grid-area']/div[3]//*[contains(@class,'product_name')]$del$",orRefName,"","");
				
		//Test step 2.
		//Control Flow IF block	
		if(setComputedActuals("5","","IFRAMES", "Home", "Foreseemodalclose","","") &&				
		executeTestStep("135",  "WAITTILLELEMENTDISPLAY","", suiteName, "PLPCLICKSEARCHRESULT", 
		...
		executeTestStep("136",  "CLICK",": Click on <Foreseemodalclose>",	suiteName, "PLPCLICKSEARCHRESULT", 
			actualData,expectedResult,actualDataRef,expectedResultRef,"",	"", "XPATH#del#//a[contains(@aria-label,'Close')]$del$",orRefName,"","");
				
		//Test step 4.
		setComputedActuals("3","","Custom", "Home","","","");			
		executeTestStep("137",  "WAIT",": Wait", suiteName, "PLPCLICKSEARCHRESULT", 
		...
		//Test step 5.
		setComputedActuals("","","PLP", "PLP","ProductNameLink2","","");			
		executeTestStep("138",  "CLICK",": Click on <ProductNameLink2>",	suiteName, "PLPCLICKSEARCHRESULT", 
			actualData,expectedResult,actualDataRef,expectedResultRef,"",	"", "XPATH#del#//*[@class='columns small-9 grid-area']/div[3]//*[contains(@class,'product_name')]$del$",orRefName,"","");
				
		//Test step 6.
		setComputedActuals("3","","PLP", "PLP","","","");			
		executeTestStep("139",  "WAIT",": Wait",	suiteName, "PLPCLICKSEARCHRESULT", 
			actualData,expectedResult,actualDataRef,expectedResultRef,"",	"", "",orRefName,"","");
		arg.updateSkippedTestStepsForTestcase("PLP_CLICKSEARCHRESULT",executedStepIds,this.exnInstId);	
	}
