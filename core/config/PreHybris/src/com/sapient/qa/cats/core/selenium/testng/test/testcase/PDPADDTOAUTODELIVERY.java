...
*
**/
public class  PDPADDTOAUTODELIVERY extends DynamicInstTestcaseClassExtend {
	    
    public PDPADDTOAUTODELIVERY(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
		    Properties prop;
			try {
	     	...
	     	LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","PDPADDTOAUTODELIVERY");
	     	this.scn_exe_tc_seq=scn_exe_tc_seq;
	     	this.testCaseId = "PDP_ADDTOAUTODELIVERY";		
	}
		
	    
		
	public  synchronized void  executeTestcase() {
		catsLogger.console("Test case is running : PDPADDTOAUTODELIVERY");
		String locString="";
		try{
		...
		if(setComputedActuals("10","","IFRAMES", "Home", "Foreseemodalclose","","") &&				
		executeTestStep("140",  "WAITTILLELEMENTDISPLAY","", suiteName, "PDPADDTOAUTODELIVERY", 
		...
		executeTestStep("141",  "CLICK",": Click on <Foreseemodalclose>",	suiteName, "PDPADDTOAUTODELIVERY", 
			actualData,expectedResult,actualDataRef,expectedResultRef,"",	"", "XPATH#del#//a[contains(@aria-label,'Close')]$del$",orRefName,"","");
				
		//Test step 3.
		setComputedActuals("2","","Custom", "Home","","","");			
		executeTestStep("142",  "WAIT",": Wait", suiteName, "PDPADDTOAUTODELIVERY", 
			actualData,expectedResult, actualDataRef,expectedResultRef,"",	"", "",orRefName,"END IF","");
		//Control Flow IF block ENDS
		}
				
		//Test step 4.
		setComputedActuals("","","PDP", "PDP","ADRadioButton","","");			
		executeTestStep("143",  "CLICK",": Click on <ADRadioButton>",	suiteName, "PDPADDTOAUTODELIVERY", 
			actualData,expectedResult,actualDataRef,expectedResultRef,"",	"", "XPATH#del#//*[@id='ad']/following-sibling::label[1]$del$",orRefName,"","");
				
		//Test step 5.
		setComputedActuals("4","","Custom", "PDP","","","");			
		executeTestStep("144",  "WAIT",": Wait",	suiteName, "PDPADDTOAUTODELIVERY", 
			actualData,expectedResult,actualDataRef,expectedResultRef,"",	"", "",orRefName,"","");
				
		//Test step 6.
		setComputedActuals("","","PDP", "PDP","AutoDeliveryButton","","");			
		executeTestStep("145",  "CLICK",": Click on <AutoDeliveryButton>",	suiteName, "PDPADDTOAUTODELIVERY", 
			actualData,expectedResult,actualDataRef,expectedResultRef,"",	"", "XPATH#del#//*[@id='addToAutoDeliveryButton']$del$",orRefName,"","");
				
		//Test step 7.
		setComputedActuals("5","","Custom", "PDP","","","");			
		executeTestStep("146",  "WAIT",": Wait",	suiteName, "PDPADDTOAUTODELIVERY", 
			actualData,expectedResult,actualDataRef,expectedResultRef,"",	"", "",orRefName,"","");
		arg.updateSkippedTestStepsForTestcase("PDP_ADDTOAUTODELIVERY",executedStepIds,this.exnInstId);	
	}
