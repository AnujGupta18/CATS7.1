...
public class  COMMON_RegisterAnAccount extends DynamicInstTestcaseClassExtend {
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "405", "ENTER",": Enter <$SignIn.Fname.FIELD1> into <Fname>","$SignIn.Fname.FIELD1","","","",null,"HomePage.LoginPage.Fname","",""));
	stepMap.put(2, new StepsMap(2, "406", "ENTER",": Enter <$SignIn.Lname.FIELD1> into <Lname>","$SignIn.Lname.FIELD1","","","",null,"HomePage.LoginPage.Lname","",""));
	stepMap.put(3, new StepsMap(3, "407", "GETRANDOMMAILID",": Get the random mail id","{{EmailID}}","8;@mailinator.com","","",null,"Custom","",""));
	stepMap.put(4, new StepsMap(4, "408", "ENTER",": Enter <{{EmailID}}> into <Email>","{{EmailID}}","","","",null,"HomePage.LoginPage.Email","",""));
	stepMap.put(5, new StepsMap(5, "409", "ENTER",": Enter <$SignIn.Password.FIELD1> into <Password>","$SignIn.Password.FIELD1","","","",null,"HomePage.LoginPage.Password","",""));
	stepMap.put(6, new StepsMap(6, "410", "ENTER",": Enter <$SignIn.ConfirmPassword.FIELD1> into <ConfirmPassword>","$SignIn.ConfirmPassword.FIELD1","","","",null,"HomePage.LoginPage.ConfirmPassword","",""));
	stepMap.put(7, new StepsMap(7, "411", "SCROLLINTOVIEW",": Scolls the <RegisterLink> into view","","","","",null,"HomePage.LoginPage.RegisterLink","",""));
	stepMap.put(8, new StepsMap(8, "412", "CLICK",": Click on <RegisterLink>","","","","",null,"HomePage.LoginPage.RegisterLink","",""));
	stepMap.put(9, new StepsMap(9, "413", "WAIT",": Wait","10","","","",null,"Custom","",""));
