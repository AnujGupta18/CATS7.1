...
*
**/
public class  PDP_VerifyBrewerCompareTable extends DynamicInstTestcaseClassExtend {

  public PDP_VerifyBrewerCompareTable(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","PDP_VerifyBrewerCompareTable");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "PDP_VerifyBrewerCompareTable";
    this.testCaseName="PDP_VerifyBrewerCompareTable";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "515", "SCROLLINTOVIEW",": Scolls the <BrewerCompareTable> into view","","","","",null,"PDP.PDP.BrewerCompareTable","",""));
	stepMap.put(2, new StepsMap(2, "516", "CLICK",": Click on <BrewerCompareTable>","","","","",null,"PDP.PDP.BrewerCompareTable","",""));
