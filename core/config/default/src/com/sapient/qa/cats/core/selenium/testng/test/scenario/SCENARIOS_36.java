...
*
**/
public class  SCENARIOS_36  extends TestConfig{
	SoftAssert softAssert;
	String testDataKey;
	String sheetName;

	private static CATSLogger catsLogger = CATSLogger.getInstance(SCENARIOS_36.class);
    ...
    public synchronized void endScenario(ITestContext context) {
		synchronized (this) {
		    try {
				...
				String scenarioID = "SCENARIOS_36";
	...
	@Test (priority=1,groups={"SCENARIOS_36"})
	public void COMMON_LaunchSite1(ITestContext context) {
		...
		try {
			...
			testCase=new COMMON_LaunchSite(context,1,"SCENARIOS_36",0, this.getSuiteDriver());
	...
	@Test (priority=2,groups={"SCENARIOS_36"})
	public void COMMON_CLOSEOVERLAY2(ITestContext context) {
		COMMON_CLOSEOVERLAY testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_CLOSEOVERLAY(context,2,"SCENARIOS_36",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=3,groups={"SCENARIOS_36"})
	public void COMMON_MyAccountClick3(ITestContext context) {
		COMMON_MyAccountClick testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_MyAccountClick(context,3,"SCENARIOS_36",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=4,groups={"SCENARIOS_36"})
	public void COMMON_RegisterAnAccount4(ITestContext context) {
		COMMON_RegisterAnAccount testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_RegisterAnAccount(context,4,"SCENARIOS_36",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=5,groups={"SCENARIOS_36"})
	public void COMMON_GlobalMsgRegistrationSuccess5(ITestContext context) {
		COMMON_GlobalMsgRegistrationSuccess testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_GlobalMsgRegistrationSuccess(context,5,"SCENARIOS_36",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=6,groups={"SCENARIOS_36"})
	public void MyAccount_BrewerRegPurDate16(ITestContext context) {
		MyAccount_BrewerRegPurDate1 testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new MyAccount_BrewerRegPurDate1(context,6,"SCENARIOS_36",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=7,groups={"SCENARIOS_36"})
	public void COMMON_CloseWindow7(ITestContext context) {
		COMMON_CloseWindow testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_CloseWindow(context,7,"SCENARIOS_36",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
