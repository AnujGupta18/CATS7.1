...
*
**/
public class  COMMON_LaunchSite extends DynamicInstTestcaseClassExtend {

  public COMMON_LaunchSite(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","COMMON_LaunchSite");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "COMMON_LaunchSite";
    this.testCaseName="COMMON_LaunchSite";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "401", "LAUNCHSITE","Launch Site","$SignIn.Url.FIELD1","","","",null,"Custom","",""));
	stepMap.put(2, new StepsMap(2, "402", "WAIT",": Wait","15","","","",null,"Custom","",""));
