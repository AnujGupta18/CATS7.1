...
*
**/
public class  HEADER_ClickCoffeeLink extends DynamicInstTestcaseClassExtend {

  public HEADER_ClickCoffeeLink(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","HEADER_ClickCoffeeLink");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "HEADER_ClickCoffeeLink";
    this.testCaseName="HEADER_ClickCoffeeLink";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "426", "HOVER",": Hover on <PodsAndMoreMenuLink>","30","","","",null,"Header.Header.PodsAndMoreMenuLink","",""));
	stepMap.put(2, new StepsMap(2, "427", "CLICKJS",": Click on the <CoffeeLink> using javascript","","","","",null,"Header.Header.CoffeeLink","",""));
	stepMap.put(3, new StepsMap(3, "428", "WAIT",": Wait","30","","","",null,"Custom","",""));
