...
*
**/
public class  SCENARIOS_32  extends TestConfig{
	SoftAssert softAssert;
	String testDataKey;
	String sheetName;

	private static CATSLogger catsLogger = CATSLogger.getInstance(SCENARIOS_32.class);
    ...
    public synchronized void endScenario(ITestContext context) {
		synchronized (this) {
		    try {
				...
				String scenarioID = "SCENARIOS_32";
	...
	@Test (priority=1,groups={"SCENARIOS_32"})
	public void COMMON_LaunchSite1(ITestContext context) {
		...
		try {
			...
			testCase=new COMMON_LaunchSite(context,1,"SCENARIOS_32",0, this.getSuiteDriver());
	...
	@Test (priority=2,groups={"SCENARIOS_32"})
	public void COMMON_CLOSEOVERLAY2(ITestContext context) {
		COMMON_CLOSEOVERLAY testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_CLOSEOVERLAY(context,2,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=3,groups={"SCENARIOS_32"})
	public void HEADER_ClickCoffeeLink3(ITestContext context) {
		HEADER_ClickCoffeeLink testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new HEADER_ClickCoffeeLink(context,3,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=4,groups={"SCENARIOS_32"})
	public void PLP_ClickProduct4(ITestContext context) {
		PLP_ClickProduct testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new PLP_ClickProduct(context,4,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=5,groups={"SCENARIOS_32"})
	public void PDP_AddToCart5(ITestContext context) {
		PDP_AddToCart testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new PDP_AddToCart(context,5,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=6,groups={"SCENARIOS_32"})
	public void PDP_MiniCartIconClick6(ITestContext context) {
		PDP_MiniCartIconClick testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new PDP_MiniCartIconClick(context,6,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=7,groups={"SCENARIOS_32"})
	public void CART_AutoDelivery7(ITestContext context) {
		CART_AutoDelivery testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new CART_AutoDelivery(context,7,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=8,groups={"SCENARIOS_32"})
	public void CART_ClickCheckOutBttn8(ITestContext context) {
		CART_ClickCheckOutBttn testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new CART_ClickCheckOutBttn(context,8,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=9,groups={"SCENARIOS_32"})
	public void COMMON_CreateAnAccount9(ITestContext context) {
		COMMON_CreateAnAccount testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_CreateAnAccount(context,9,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=10,groups={"SCENARIOS_32"})
	public void Shipping_FillShippingDetails10(ITestContext context) {
		Shipping_FillShippingDetails testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new Shipping_FillShippingDetails(context,10,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=11,groups={"SCENARIOS_32"})
	public void Payment_VISALoggedInUser11(ITestContext context) {
		Payment_VISALoggedInUser testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new Payment_VISALoggedInUser(context,11,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=12,groups={"SCENARIOS_32"})
	public void Review_PlaceOrder112(ITestContext context) {
		Review_PlaceOrder1 testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new Review_PlaceOrder1(context,12,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=13,groups={"SCENARIOS_32"})
	public void COMMON_CloseWindow13(ITestContext context) {
		COMMON_CloseWindow testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_CloseWindow(context,13,"SCENARIOS_32",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
