...
*
**/
public class  PLP_ClickProduct extends DynamicInstTestcaseClassExtend {

  public PLP_ClickProduct(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","PLP_ClickProduct");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "PLP_ClickProduct";
    this.testCaseName="PLP_ClickProduct";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "434", "SCROLLINTOVIEW",": Scolls the <ProductLink> into view","","","","",null,"PLP.PLP.ProductLink","",""));
	stepMap.put(2, new StepsMap(2, "435", "CLICKJS",": Click on the <ProductLink> using javascript","","","","",null,"PLP.PLP.ProductLink","",""));
	stepMap.put(3, new StepsMap(3, "436", "WAIT",": Wait","15","","","",null,"Custom","",""));
