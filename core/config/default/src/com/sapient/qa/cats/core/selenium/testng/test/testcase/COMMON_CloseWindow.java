...
*
**/
public class  COMMON_CloseWindow extends DynamicInstTestcaseClassExtend {

  public COMMON_CloseWindow(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","COMMON_CloseWindow");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "COMMON_CloseWindow";
    this.testCaseName="COMMON_CloseWindow";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "415", "CLOSEWINDOW",": Close the window","","","","",null,"Custom","",""));
