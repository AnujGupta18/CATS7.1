...
*
**/
public class  COMMON_CreateAnAccount extends DynamicInstTestcaseClassExtend {

  public COMMON_CreateAnAccount(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","COMMON_CreateAnAccount");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "COMMON_CreateAnAccount";
    this.testCaseName="COMMON_CreateAnAccount";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "459", "ENTER",": Enter <$SignIn.Fname.FIELD1> into <Fname>","$SignIn.Fname.FIELD1","","","",null,"HomePage.LoginPage.Fname","",""));
	stepMap.put(2, new StepsMap(2, "460", "ENTER",": Enter <$SignIn.Lname.FIELD1> into <Lname>","$SignIn.Lname.FIELD1","","","",null,"HomePage.LoginPage.Lname","",""));
	stepMap.put(3, new StepsMap(3, "461", "GETRANDOMMAILID",": Get the random mail id","{{EmailID}}","8;@mailinator.com","","",null,"Custom","",""));
	stepMap.put(4, new StepsMap(4, "462", "ENTER",": Enter <{{EmailID}}> into <Email>","{{EmailID}}","","","",null,"HomePage.LoginPage.Email","",""));
	stepMap.put(5, new StepsMap(5, "463", "ENTER",": Enter <$SignIn.Password.FIELD1> into <Password>","$SignIn.Password.FIELD1","","","",null,"HomePage.LoginPage.Password","",""));
	stepMap.put(6, new StepsMap(6, "464", "ENTER",": Enter <$SignIn.ConfirmPassword.FIELD1> into <ConfirmPassword>","$SignIn.ConfirmPassword.FIELD1","","","",null,"HomePage.LoginPage.ConfirmPassword","",""));
	stepMap.put(7, new StepsMap(7, "465", "SCROLLINTOVIEW",": Scolls the <CreateAnAccountBttn> into view","","","","",null,"HomePage.LoginPage.CreateAnAccountBttn","",""));
	stepMap.put(8, new StepsMap(8, "466", "CLICK",": Click on <CreateAnAccountBttn>","","","","",null,"HomePage.LoginPage.CreateAnAccountBttn","",""));
	stepMap.put(9, new StepsMap(9, "467", "WAIT",": Wait","10","","","",null,"Custom","",""));
