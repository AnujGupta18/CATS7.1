...
*
**/
public class  CART_ClickCheckOutBttn extends DynamicInstTestcaseClassExtend {

  public CART_ClickCheckOutBttn(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","CART_ClickCheckOutBttn");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "CART_ClickCheckOutBttn";
    this.testCaseName="CART_ClickCheckOutBttn";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "455", "SCROLLINTOVIEW",": Scolls the <CheckoutBttn> into view","","","","",null,"Cart.Cart.CheckoutBttn","",""));
	stepMap.put(2, new StepsMap(2, "456", "WAITTILLELEMENTDISPLAY","","10","","","",null,"Cart.Cart.CheckoutBttn","",""));
	stepMap.put(3, new StepsMap(3, "457", "CLICK",": Click on <CheckoutBttn>","","","","",null,"Cart.Cart.CheckoutBttn","",""));
	stepMap.put(4, new StepsMap(4, "458", "WAIT",": Wait","10","","","",null,"Custom","",""));
