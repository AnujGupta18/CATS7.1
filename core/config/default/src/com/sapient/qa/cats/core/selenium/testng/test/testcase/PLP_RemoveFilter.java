...
*
**/
public class  PLP_RemoveFilter extends DynamicInstTestcaseClassExtend {

  public PLP_RemoveFilter(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","PLP_RemoveFilter");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "PLP_RemoveFilter";
    this.testCaseName="PLP_RemoveFilter";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "531", "SCROLLINTOVIEW",": Scolls the <CloseFacetXSign> into view","","","","",null,"PLP.Facets.CloseFacetXSign","",""));
	stepMap.put(2, new StepsMap(2, "532", "CLICK",": Click on <CloseFacetXSign>","","","","",null,"PLP.Facets.CloseFacetXSign","",""));
