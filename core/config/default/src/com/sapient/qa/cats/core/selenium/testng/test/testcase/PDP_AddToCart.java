...
*
**/
public class  PDP_AddToCart extends DynamicInstTestcaseClassExtend {

  public PDP_AddToCart(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","PDP_AddToCart");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "PDP_AddToCart";
    this.testCaseName="PDP_AddToCart";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "437", "WAITTILLELEMENTDISPLAY","","10","","","",null,"PDP.PDP.QtyIncreaseIcon","",""));
	stepMap.put(2, new StepsMap(2, "438", "CLICK",": Click on <QtyIncreaseIcon>","","","","",null,"PDP.PDP.QtyIncreaseIcon","",""));
	stepMap.put(3, new StepsMap(3, "439", "SCROLLINTOVIEW",": Scolls the <AddToCartBttn> into view","10","","","",null,"PDP.PDP.AddToCartBttn","",""));
	stepMap.put(4, new StepsMap(4, "440", "CLICK",": Click on <AddToCartBttn>","","","","",null,"PDP.PDP.AddToCartBttn","",""));
	stepMap.put(5, new StepsMap(5, "441", "WAIT",": Wait","5","","","",null,"Custom","",""));
