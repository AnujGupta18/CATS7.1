...
*
**/
public class  SCENARIOS_30  extends TestConfig{
	SoftAssert softAssert;
	String testDataKey;
	String sheetName;

	private static CATSLogger catsLogger = CATSLogger.getInstance(SCENARIOS_30.class);
    ...
    public synchronized void endScenario(ITestContext context) {
		synchronized (this) {
		    try {
				...
				String scenarioID = "SCENARIOS_30";
	...
	@Test (priority=1,groups={"SCENARIOS_30"})
	public void COMMON_LaunchSite1(ITestContext context) {
		...
		try {
			...
			testCase=new COMMON_LaunchSite(context,1,"SCENARIOS_30",0, this.getSuiteDriver());
	...
	@Test (priority=2,groups={"SCENARIOS_30"})
	public void COMMON_CLOSEOVERLAY2(ITestContext context) {
		COMMON_CLOSEOVERLAY testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_CLOSEOVERLAY(context,2,"SCENARIOS_30",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=3,groups={"SCENARIOS_30"})
	public void COMMON_MyAccountClick3(ITestContext context) {
		COMMON_MyAccountClick testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_MyAccountClick(context,3,"SCENARIOS_30",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=4,groups={"SCENARIOS_30"})
	public void COMMON_RegisterAnAccount4(ITestContext context) {
		COMMON_RegisterAnAccount testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_RegisterAnAccount(context,4,"SCENARIOS_30",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=5,groups={"SCENARIOS_30"})
	public void COMMON_GlobalMsgRegistrationSuccess5(ITestContext context) {
		COMMON_GlobalMsgRegistrationSuccess testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_GlobalMsgRegistrationSuccess(context,5,"SCENARIOS_30",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=6,groups={"SCENARIOS_30"})
	public void HEADER_ClickCoffeeLink6(ITestContext context) {
		HEADER_ClickCoffeeLink testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new HEADER_ClickCoffeeLink(context,6,"SCENARIOS_30",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=7,groups={"SCENARIOS_30"})
	public void PLP_VerifyPagination7(ITestContext context) {
		PLP_VerifyPagination testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new PLP_VerifyPagination(context,7,"SCENARIOS_30",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
	...
	@Test (priority=8,groups={"SCENARIOS_30"})
	public void COMMON_CloseWindow8(ITestContext context) {
		COMMON_CloseWindow testCase=null;
		try {
			LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_DATAKEY","");
			testCase=new COMMON_CloseWindow(context,8,"SCENARIOS_30",0, this.getSuiteDriver());
			testCase.setTestDataKey("");
			testCase.executeTestcase();
