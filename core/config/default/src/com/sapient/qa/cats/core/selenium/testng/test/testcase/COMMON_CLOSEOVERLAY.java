...
*
**/
public class  COMMON_CLOSEOVERLAY extends DynamicInstTestcaseClassExtend {

  public COMMON_CLOSEOVERLAY(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","COMMON_CLOSEOVERLAY");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "COMMON_CLOSEOVERLAY";
    this.testCaseName="COMMON_CLOSEOVERLAY";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "416", "WAITTILLELEMENTDISPLAY","","7","","","",null,"Header.Header.CloseOverlay","IF",""));
	stepMap.put(2, new StepsMap(2, "417", "CLICK",": Click on <CloseOverlay>","","","","",null,"Header.Header.CloseOverlay","",""));
	stepMap.put(3, new StepsMap(3, "418", "WAIT",": Wait","1","","","",null,"Custom","END IF",""));

    //Test step 1.
    //Control Flow IF block
    if(executeTestStep(stepMap.get(1))){
    //Test step 2.
