...
*
**/
public class  CART_MiniCartItemAddVerify extends DynamicInstTestcaseClassExtend {

  public CART_MiniCartItemAddVerify(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","CART_MiniCartItemAddVerify");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "CART_MiniCartItemAddVerify";
    this.testCaseName="CART_MiniCartItemAddVerify";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "543", "SCROLLINTOVIEW",": Scolls the <MiniCartItemCount> into view","","","","",null,"Cart.Cart.MiniCartItemCount","",""));
	stepMap.put(2, new StepsMap(2, "544", "VERIFYELEMENTPRESENT",": Verify the <MiniCartItemCount> is Present","","","","",null,"Cart.Cart.MiniCartItemCount","",""));
