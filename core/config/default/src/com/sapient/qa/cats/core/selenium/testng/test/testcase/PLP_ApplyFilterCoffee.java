...
*
**/
public class  PLP_ApplyFilterCoffee extends DynamicInstTestcaseClassExtend {

  public PLP_ApplyFilterCoffee(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","PLP_ApplyFilterCoffee");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "PLP_ApplyFilterCoffee";
    this.testCaseName="PLP_ApplyFilterCoffee";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "527", "CLICK",": Click on <Facet1CoffeeFormat>","","","","",null,"PLP.Facets.Facet1CoffeeFormat","",""));
	stepMap.put(2, new StepsMap(2, "528", "WAIT",": Wait","5","","","",null,"Custom","",""));
	stepMap.put(3, new StepsMap(3, "529", "CLICK",": Click on <Facet1CoffeeFormatSub>","","","","",null,"PLP.Facets.Facet1CoffeeFormatSub","",""));
	stepMap.put(4, new StepsMap(4, "530", "WAIT",": Wait","5","","","",null,"Custom","",""));
