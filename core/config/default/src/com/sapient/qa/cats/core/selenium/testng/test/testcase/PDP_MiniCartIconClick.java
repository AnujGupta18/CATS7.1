...
*
**/
public class  PDP_MiniCartIconClick extends DynamicInstTestcaseClassExtend {

  public PDP_MiniCartIconClick(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","PDP_MiniCartIconClick");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "PDP_MiniCartIconClick";
    this.testCaseName="PDP_MiniCartIconClick";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "442", "WAITTILLELEMENTDISPLAY","","10","","","",null,"PDP.PDP.CartIcon","",""));
	stepMap.put(2, new StepsMap(2, "443", "CLICK",": Click on <CartIcon>","","","","",null,"PDP.PDP.CartIcon","",""));
	stepMap.put(3, new StepsMap(3, "444", "WAIT",": Wait","5","","","",null,"Custom","",""));
