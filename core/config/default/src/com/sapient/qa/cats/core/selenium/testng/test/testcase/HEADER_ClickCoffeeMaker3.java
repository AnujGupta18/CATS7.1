...
*
**/
public class  HEADER_ClickCoffeeMaker3 extends DynamicInstTestcaseClassExtend {

  public HEADER_ClickCoffeeMaker3(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","HEADER_ClickCoffeeMaker3");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "HEADER_ClickCoffeeMaker3";
    this.testCaseName="HEADER_ClickCoffeeMaker3";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "509", "HOVER",": Hover on <CoffeeMakersMenuLink>","10","","","",null,"Header.Header.CoffeeMakersMenuLink","",""));
	stepMap.put(2, new StepsMap(2, "510", "CLICKJS",": Click on the <CoffeeMakersFeatures> using javascript","","","","",null,"HomePage.MenuItems.CoffeeMakersFeatures","",""));
	stepMap.put(3, new StepsMap(3, "511", "WAIT",": Wait","30","","","",null,"Custom","",""));
	stepMap.put(4, new StepsMap(4, "512", "CLICK",": Click on <ShopNow>","","","","",null,"HomePage.MenuItems.ShopNow","",""));
