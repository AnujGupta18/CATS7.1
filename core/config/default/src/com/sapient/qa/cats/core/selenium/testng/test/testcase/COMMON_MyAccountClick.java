...
*
**/
public class  COMMON_MyAccountClick extends DynamicInstTestcaseClassExtend {

  public COMMON_MyAccountClick(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","COMMON_MyAccountClick");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "COMMON_MyAccountClick";
    this.testCaseName="COMMON_MyAccountClick";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "403", "CLICK",": Click on <AccountLink>","","","","",null,"HomePage.HomePage.AccountLink","",""));
	stepMap.put(2, new StepsMap(2, "404", "WAIT",": Wait","10","","","",null,"Custom","",""));
