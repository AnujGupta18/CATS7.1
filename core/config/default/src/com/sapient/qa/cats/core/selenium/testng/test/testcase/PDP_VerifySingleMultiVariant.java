...
*
**/
public class  PDP_VerifySingleMultiVariant extends DynamicInstTestcaseClassExtend {

  public PDP_VerifySingleMultiVariant(ITestContext context,long scn_exe_tc_seq,String scenarioId,long scn_data_key_seq,RemoteWebDriver driver){
    Properties prop;
    try {
    ...
    LangDataSingleton.getInstanceOf("_ENV_"+this.suiteName).put("CURR_TCNAME","PDP_VerifySingleMultiVariant");
    this.scn_exe_tc_seq=scn_exe_tc_seq;
    this.testCaseId = "PDP_VerifySingleMultiVariant";
    this.testCaseName="PDP_VerifySingleMultiVariant";
  }
  ...
  public  synchronized void  executeTestcase() {
	...
	stepMap.put(1, new StepsMap(1, "533", "SCROLLINTOVIEW",": Scolls the <MultiAndSingleVarPricePanel> into view","","","","",null,"PDP.PDP.MultiAndSingleVarPricePanel","",""));
	stepMap.put(2, new StepsMap(2, "534", "VERIFYELEMENTPRESENT",": Verify the <MultiAndSingleVarPricePanel> is Present","","","","",null,"PDP.PDP.MultiAndSingleVarPricePanel","",""));
